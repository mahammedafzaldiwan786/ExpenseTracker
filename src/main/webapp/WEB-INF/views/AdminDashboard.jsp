...
<title>AdminDashboard | Home</title>
              ...
              <!--     <div class="filter">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>${TotalExpensesForThisMonth}</h6>
          ...
          <!--      <div class="filter">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>${TotalExpensesForThisYear}</h6>
