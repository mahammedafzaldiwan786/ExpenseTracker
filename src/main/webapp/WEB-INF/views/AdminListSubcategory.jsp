...
<title>AdminDashboard | List Subcategory</title>
										...
										<tbody>
											...
											<c:forEach items="${allsubcategoryt}" var="subcategory">
												...
												<tr>
													<td>${subcategory[3] }</td>
													<td>${subcategory[4] }</td>
													<td><a href="adminviewsubcategory?subcategoryId=${subcategory[0]}" class="btn btn-primary">View</a> <a href="admineditsubcategory?subcategoryId=${subcategory[0]}" class="btn btn-success">Edit</a>  <a href="admindeletesubcategory?subcategoryId=${subcategory[0]}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
