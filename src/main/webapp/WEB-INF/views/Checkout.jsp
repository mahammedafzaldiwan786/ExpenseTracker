...
<title>Expense Tracker | Check Out</title>
  ...
  <main id="main" class="main">
		...
		<!-- End Page Title -->
              ...
              <form action="pay" method="post">
				   <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" name="accountName">Amount :</label>
                  <div class="col-sm-10">
                    <input  class="form-control"  type="text" readonly="readonly" value="${amount}"">
                  </div>
                </div>
                
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" name="amount">Credit Card :</label>
                  <div class="col-sm-10">
                    <input class="form-control" type="text" size="16" name="ccNum">
                  </div>
                </div>
                
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" name="description">Exp Date : </label>
                  <div class="col-sm-10">
                    <input class="form-control" type="text" name="expDate" size="4">
                  </div>
                </div>
