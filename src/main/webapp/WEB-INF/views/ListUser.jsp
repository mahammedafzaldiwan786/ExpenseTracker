...
<title>AdminDashboard | List User</title>
										...
										<tbody>
	   										...
	   										<c:forEach items="${userList}" var="user">
	   											...
	   											<!--	<td>${user.city }</td>			-->
	   												...
	   												<td>${user.gender }</td>
	   												<td><a href="adminviewuser?userId=${user.userId}" class="btn btn-primary">View</a>  <a href="adminedituser?userId=${user.userId}" class="btn btn-success">Edit</a>  <a href="admindeleteuser?userId=${user.userId}" class="btn btn-danger">Delete</a> </td>
	   											</tr>
	   										</c:forEach>
										</tbody>
