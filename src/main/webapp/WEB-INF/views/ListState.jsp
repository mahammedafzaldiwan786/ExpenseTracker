...
<title>AdminDashboard | List State</title>
										...
										<tbody>
											...
											<c:forEach items="${allState}" var="state">
												<tr>
													...
													<td><a href="adminviewstate?stateId=${state.stateId}" class="btn btn-success">View</a>  <a href="admineditstate?stateId=${state.stateId}" class="btn btn-primary">Edit</a>  <a href="admindeletestate?stateId=${state.stateId}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
