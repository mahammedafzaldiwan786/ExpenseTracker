...
<title>AdminDashboard | List Income</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Income</a></li>
										...
										<tbody>
											...
											<c:forEach items="${incomeList}" var="income">
												...
												<tr>
													...
													<td><a href="adminviewincome?incomeId=${income.incomeId}" class="btn btn-primary">View</a>   <a href="admineditincome?incomeId=${income.incomeId}" class="btn btn-success">Edit</a>   <a href="admindeleteincome?incomeId=${income.incomeId}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
