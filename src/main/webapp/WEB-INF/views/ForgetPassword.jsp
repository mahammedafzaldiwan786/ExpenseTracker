          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="forgetpassword" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your email to get otp and reset password</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="sendOtp" method="post" >
