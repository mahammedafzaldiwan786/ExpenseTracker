...
<title>AdminDashboard | List Vendor</title>
										...
										<tbody>
											...
											<c:forEach items="${vendorList}" var="vendor">
												...
												<tr>
													...
													<td><a href="adminviewvendor?vendorId=${vendor.vendorId}" class="btn btn-primary">View</a>    <a href="admineditvendor?vendorId=${vendor.vendorId}" class="btn btn-success">Edit</a>   <a href="admindeletevendor?vendorId=${vendor.vendorId}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
