							...
							<div class="card">
								...
								<div class="card-body">
									...
									<!--  				<td>${expense.description }</td>        -->
													<td><a href="adminviewexpense?expenseId=${expense.expenseId}" class="btn btn-primary">View</a>  <a href="admineditexpense?expenseId=${expense.expenseId}" class="btn btn-success">Edit</a>  <a href="admindeleteexpense?expenseId=${expense.expenseId}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
