...
<title>AdminDashboard | List Account</title>
										...
										<tbody>
												...
												<c:forEach items="${accountList}" var="account">
														...
														<tr>
															...
															<td><a href="adminviewaccount?accountId=${account.accountId}" class="btn btn-primary">View</a>         <a href="admineditaccount?accountId=${account.accountId}" class="btn btn-success">Edit</a>           <a href="admindeleteaccount?accountId=${account.accountId}" class="btn btn-danger">Delete</a> </td>
														</tr>
												</c:forEach>
										</tbody>
