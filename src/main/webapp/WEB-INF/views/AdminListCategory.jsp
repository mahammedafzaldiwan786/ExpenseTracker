...
<title>AdminDashboard | List Category</title>
										...
										<tbody>
											...
											<c:forEach items="${categoryList}" var="category">
												...
												<tr>
													...
													<td><a href="adminviewcategory?categoryId=${category.categoryId}" class="btn btn-primary">View</a>  <a href="admineditcategory?categoryId=${category.categoryId}" class="btn btn-success">Edit</a>  <a href="admindeletecategory?categoryId=${category.categoryId}" class="btn btn-danger">Delete</a> </td>
												</tr>
											</c:forEach>
										</tbody>
