...
<title>AdminDashboard | List City</title>
...
<!-- ======= Header ======= -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">City</a></li>
										...
										<tbody>
											...
											<c:forEach items="${allCity}" var="city">
												<tr>
													<td>${city[1]}</td>
													<td>${city[3]}</td>
													<td><a href="adminviewcity?cityId=${city[0]}" class="btn btn-primary">View</a>  <a href="admineditcity?cityId=${city[0]}" class="btn btn-success">Edit</a>  <a href="admindeletecity?cityId=${city[0]}" class="btn btn-danger">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
